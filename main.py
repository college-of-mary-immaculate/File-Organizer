...
class File_Organizer(tk.Tk):
    def __init__(self):
        ...
        self.menu_frame = tk.Frame(self,bg='#002379',width=1280,height=720)
        self.home_frame = tk.Frame(self,bg='#AFDDE5',width=1280,height=720)
        self.help_frame = tk.Frame(self,bg='#AFDDE5',width=1280,height=720)
        self.about_frame = tk.Frame(self, bg='#AFDDE5',width=1280,height=720)
    ...
    def create_directory_if_does_not_exist(self,directory):
        #create a folder if the path is not exist
        if not os.path.exists(directory):
    ...
    def selection_sort_files(self,array_files):
        n = len(array_files)
        for i in range(n - 1):
            min_index = i
            for j in range(i + 1, n):
                ...
                # sorting base on their extension
    ...
    def organize_files(self,directory,config):
        ...
        #iterate through the given directory and append it to array
        for filename in os.listdir(directory):
            src_file = os.path.join(directory,filename)
            if os.path.isfile(src_file):
                files_to_sort.append(filename)

        # Return the Sorted files base on their Extension
        sorted_files = self.selection_sort_files(files_to_sort)
        ...
        for filename in sorted_files:
            ...
            #iterate through Dictionary in json file
